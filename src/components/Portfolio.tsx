...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Cloud",
      description: "Scalable cloud resource management and monitoring system",
    ...
    },
    {
      ...
      category: "AI",
      description: "Automated ML workflow for data processing and model training",
    ...
    },
    {
      ...
      category: "Cloud",
      description: "High-performance API gateway with auto-scaling capabilities",
    ...
    },
    {
      ...
      category: "Web",
      description: "Interactive data visualization dashboard with live updates",
      tech: ["Vue.js", "WebSockets", "D3.js", "Node.js"],
