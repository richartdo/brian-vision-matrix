...
const Study = () => {
  ...
  const education = [
    ...
    },
    {
      ...
      date: "2016 - 2020",
      description: "Comprehensive study in software development, algorithms, and system design with honors distinction.",
      icon: BookOpen,
    },
    {
    ...
    },
    {
      ...
      institution: "Google",
      date: "2021",
      description: "Proficiency in building and deploying machine learning models using TensorFlow.",
      icon: FileCheck,
    },
  ];
