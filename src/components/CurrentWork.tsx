  ...
  const projects = [
    {
      ...
      description: "Building a comprehensive analytics platform that leverages machine learning to provide real-time insights and predictive analytics for enterprise clients.",
    ...
    },
    {
      ...
      status: "Ongoing",
      description: "Leading the migration of monolithic applications to microservices architecture on Kubernetes, improving scalability and maintainability.",
      tech: ["Kubernetes", "Go", "gRPC", "Helm", "Prometheus"],
      progress: 60,
      icon: Zap,
    ...
    },
    {
      ...
      status: "Active",
      description: "Contributing to an open-source machine learning framework focused on simplifying model deployment and monitoring in production environments.",
